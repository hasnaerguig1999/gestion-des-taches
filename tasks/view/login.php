          ...
          <div class="row d-flex align-items-center justify-content-center h-100">
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1" id="bor">
              <form  method="post" autocomplete="off">
                ...
                <!-- Submit button -->
                <button type="submit" class="btn btn-primary btn-lg btn-block" name="adduser">Login</button><br>
                <button type="submit" class="btn btn-primary btn-lg btn-block" name="register">Login</button><br>
              </form>
            </div>
          </div>
        </div>
